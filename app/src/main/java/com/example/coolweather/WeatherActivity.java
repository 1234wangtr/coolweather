...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT>=21){//背景图和状态栏融为一体
    ...
    private void loadBingPic(){
        ...
        //Log.d("mdebug","bing pic is:"+requestBingPic);
    ...
    private void showWeatherInfo(Weather weather){
        ...
        String degree=weather.now.temperathure+"℃";
        ...
        for(Forecast forecast:weather.forecastList){
            Log.d("mdebug",forecast.date);
            Log.d("mdebug",forecast.temperature._max);
            ...
            maxText.setText(forecast.temperature._max);
            minText.setText(forecast.temperature._min);
